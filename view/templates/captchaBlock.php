<div class="shadow my-3 px-3 mx-0 mx-lg-4 bg-primary text-white  rounded   text-center d-flex align-items-center">
    <div class="d-flex flex-column align-items-center">
        <label for="studyField" class="form-label fw-bold ">ReCaptcha</label>
